<div class="container clearfix">
    ...
    <div class="content">
        ...
        <h2 class="pt-3 pb-3" data-animated="fadeInUp">Как распознать неисправность рулевого редуктора:</h2>
        <div class="row pb-5 row-center">            
            <div class="col-md-7 col-12 lh pb-3">
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            ...
                            <div class="col-md-7 col-9">Тугое вращение руля в двух направлениях, либо полностью отказ вращения руля</div>
                        </div>
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/2.png" alt="Во-вторых"></div>
                            <div class="col-md-7 col-9">Появление люфта на руле</div>
                        </div>
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/3.png" alt="В-третьих"></div>
                            <div class="col-md-7 col-9">При повороте руля раздается скрежет, хруст, либо другие нехарактерные звуки</div>
                        </div>   
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/4.png" alt="В-четвертых"></div>
                            <div class="col-md-7 col-9">Руль не возвращается в исходное положение</div>
                        </div> 
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/5.png" alt="В-пятых"></div>
                            <div class="col-md-7 col-9">Течь масла редуктора (жидкости ГУР)</div>
                        </div> 
                        <div class="text-center" data-animated="fadeInUp"><b>Диагностика релевых редукторов всего за 1 час!</b><br><br>
            ...
            <div class="col-md-5 col-12 fn" data-animated="fadeInRight">
                <p><?= (!is_null($parent) ? $this->Html->image("/img/logo_model/".$parent->img.".png",['alt'=>$parent->menu]) : $this->Html->image("/img/logo_model/".$page->first()->img.".png",['alt'=>$page->first()->menu])); ?></p>        
            </div>
        ...
        <div class="row pt-3">
            <div class="col-md-6 col-12"   itemscope itemtype="http://schema.org/Product">
                ...
                <div class="table container" data-animated="fadeInUp" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div class="row t">
                        <div class="col-md-8 col-7" itemprop="name">Ремонт рулевого редуктора</div>
                ...
                <div class="pt-4 lh pb-3" data-animated="fadeInUp">
                    <p  itemprop="description">Автосервис "Ремонт рулевых реек" качественно и максимально быстро выполнит <b>ремонт рулевых редукторов</b> вашего автомобиля любой сложности.</p>
                </div>
            </div>
            <div class="col-md-5 col-12 lh pl" data-animated="fadeInRight">
                    <h2><?= $page->first()->name ?> включает в себя следующее:</h2>
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            ...
                            <div class="col-md-10 col-9">Специалисты нашего автосервиса проведут полную диагностику редуктора. Не всегда замена сальника устранит проблемы течи редуктора.</div>
                        </div>                        
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-2 col-3"><img src="/img/2.png" alt="Во-вторых"></div>
                            <div class="col-md-10 col-9">Устранение неисправностей редуктора, либо устранение нарушений герметичности</div>
                        </div>                         
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-2 col-3"><img src="/img/3.png" alt="В-третьих"></div>
                            <div class="col-md-10 col-9">Тестирование редуктора на диагностическом стенде</div>
                        </div>      
            </div>
        </div>
