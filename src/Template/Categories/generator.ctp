<div class="container clearfix">
    ...
    <div class="content">
        ...
        <h2 class="pt-3 pb-3" data-animated="fadeInUp">Причины поломки генератора:</h2>
        <div class="row pb-5 row-center">            
            <div class="col-md-7 col-12 lh pb-3">
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            ...
                            <div class="col-md-7 col-9">Износ шкива или подшипника генератора</div>
                        </div>
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/2.png" alt="Во-вторых"></div>
                            <div class="col-md-7 col-9">Требуется ремонт диодного моста или реле регулятора генератора</div>
                        </div>
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/3.png" alt="В-третьих"></div>
                            <div class="col-md-7 col-9">Повреждение обмотки или корпуса генератора</div>
                        </div>   
                        <div class="row row-center pb-3" data-animated="fadeInUp">
                            <div class="col-md-1 col-3 text-right"><img src="/img/4.png" alt="В-четвертых"></div>
                            <div class="col-md-7 col-9">Требуется ремонт натяжителя ремня генератора, щеток, обгонной муфты, якоря, ролика</div>
                        </div> 
                        <div class="text-center" data-animated="fadeInUp"><b>Бесплатная диагностика генератора</b><br><br>
            ...
            <div class="col-md-5 col-12 fn" data-animated="fadeInRight">
                <p><?= $this->Html->image("/img/generator1.jpg"); ?></p>        
            </div>
        ...
        <div class="row pt-3">
            <div class="col-md-6 col-12"   itemscope itemtype="http://schema.org/Product">
                ...
                <div class="table container" data-animated="fadeInUp" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div class="row t">
                        <div class="col-md-8 col-7" itemprop="name">Ремонт генератора</div>
                ...
                <div class="pt-4 lh pb-3" data-animated="fadeInUp">
                    <p  itemprop="description">Автосервис "Ремонт рулевых реек" качественно и максимально быстро выполнит <b>ремонт генератора</b> вашего автомобиля любой сложности.</p>
                </div>
            </div>            
        </div>
