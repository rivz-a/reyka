<div class="container clearfix">
    ...
    <div class="content">
        ...
        <h2 class="pt-3 pb-3" data-animated="fadeInUp">Как распознать неисправность насоса гидроусилителя руля (ГУР):</h2>
        ...
        <div class="row pt-3">
            <div class="col-md-6 col-12"  itemscope itemtype="http://schema.org/Product">
                ...
                <div class="table container" data-animated="fadeInUp" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    ...
                    <div class="row t">
                        <div class="col-md-8 col-7" itemprop="name">Ремонт насоса ГУР</div>
