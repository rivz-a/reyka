...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserUploadUrl = '/js/ckeditor/kcfinder/browse.php?opener=ckeditor&type=files';
	config.filebrowserImageUploadUrl = '/js/ckeditor/kcfinder/browse.php?opener=ckeditor&type=images';
	config.filebrowserFlashUploadUrl = '/js/ckeditor/kcfinder/browse.php?opener=ckeditor&type=flash';
