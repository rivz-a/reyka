...
var path = {
    ...
    src: {       
        ...
        style: 'webroot/src/css/main.scss',
        img: 'webroot/src/img/**/*.*',
        fonts: 'webroot/src/fonts/**/*.*'
    },
    watch: {        
        js: 'webroot/src/js/**/*.js',
        css: 'webroot/src/css/*.scss',
        img: 'webroot/src/img/**/*.*',
        fonts: 'webroot/srs/fonts/**/*.*'
    },
    clean: './webroot/build/*'
};
...
gulp.task('watch', function () {    
    ...
    gulp.watch("webroot/src/css/*.scss").on('change', webserver.reload); 
